...
import { FaLock, FaEnvelope, FaCloud, FaShieldAlt, FaFolder, FaUsers, FaEye, FaEyeSlash } from 'react-icons/fa';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('user', JSON.stringify({
        ...
        role: data.role, department: data.department, storageQuota: data.storageQuota,
        storageUsed: data.storageUsed, mustChangePassword: data.mustChangePassword
      }));
      toast.success(`Welcome back, ${data.fullName}!`);
      navigate(data.mustChangePassword ? '/profile' : '/dashboard', data.mustChangePassword ? { state: { forcePasswordChange: true } } : undefined);
    } catch (error) {
        ...
        <div className="w-full max-w-sm animate-fadeInUp">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-700 to-blue-800 px-6 py-5">
              ...
              <p className="text-blue-200 text-sm mt-0.5">Sign in to your academic account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} noValidate className="p-6 space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input name="email" type="email" required disabled={loading} placeholder="name@udom.ac.tz" value={formData.email} onChange={handleChange} autoComplete="email"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input name="password" type={showPassword ? "text" : "password"} required disabled={loading} placeholder="Enter your password" value={formData.password} onChange={handleChange} autoComplete="current-password"
